...
const messages = {
  id: {
    ...
    round: "Paket",
    otherTests: "Simulasi lainnya",
    recentScore: "Nilai terbaru",
    ...
    showTranscript: "Lihat transkrip",
    hideTranscript: "Sembunyikan transkrip",
    listening: "Menyimak",
    audioAutoPlay: "Putar otomatis",
    audioAutoPlayWaiting: "Diputar otomatis dalam 3 detik",
    audioFreeReplay: "Dapat diputar ulang",
    audioReady: "Siap diputar",
    audioLoading: "Memuat audio",
    audioPlaying: "Sedang diputar",
    audioComplete: "Pemutaran selesai",
    audioError: "Audio tidak tersedia",
    audioPlay: "Putar",
    audioReplay: "Putar ulang",
    audioBlocked: "Tekan tombol putar untuk memulai.",
    audioReplayLimit: "Batas pemutaran telah tercapai.",
    audioLoadFailed: "Audio tidak dapat dimuat.",
