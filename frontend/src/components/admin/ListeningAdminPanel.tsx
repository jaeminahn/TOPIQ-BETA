...
export function ListeningAdminPanel({
  ...
  return <section className="rounded-2xl border border-gray-200 bg-white p-5 sm:p-7">
    ...
    {editing&&<AdminQuestionEditorDialog token={token} section="listening" setId={editing.group.setId} setVersion={editing.group.setVersion} question={editing.target} groupQuestions={editing.group.targets} onClose={()=>setEditing(null)} onSaved={()=>{setEditing(null);setSelectedSet(null);setItems([]);void onSetsChanged();}}/>}
