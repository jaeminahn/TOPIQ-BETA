import { BookOpen, CheckCircle2, CircleAlert, FileCheck2, Image, LoaderCircle, Pencil, Plus, RefreshCw, Sparkles, Trash2, Upload } from "lucide-react";
