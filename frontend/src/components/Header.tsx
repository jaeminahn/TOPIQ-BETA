        ...
        <div className="flex items-center rounded-full border border-gray-300 p-0.5">
          ...
          {(["id", "ko"] as const).map((value) => (
            <button
              ...
              className={`focus-ring ml-0.5 min-h-9 rounded-full px-2.5 py-1 text-[11px] font-semibold ${locale === value ? "bg-primary text-white" : "text-gray-500 hover:text-gray-800"}`}
