      ...
      <main className="mx-auto max-w-2xl px-4 py-6 sm:px-8 sm:py-8">
        <div className="rounded-2xl border border-gray-300 bg-white p-6 sm:p-8">
          <div className="text-center">
            <span className="mx-auto grid size-11 place-items-center rounded-xl bg-primary-50 text-primary"><Star className="size-6" /></span>
            <h1 className="mt-3 text-2xl font-semibold text-gray-900">{t("feedbackTitle")}</h1>
          ...
          <div className="mt-5 border-t border-gray-100 pt-5">
            <label className="flex cursor-pointer items-start gap-3 font-semibold text-gray-800">
