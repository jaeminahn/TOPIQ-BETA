  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="mx-auto max-w-[1500px] px-5 py-7 sm:px-8">
        ...
        {tab === "overview" && summary && <AdminOverview summary={summary} jobs={jobs} emailBusy={busy === "email-settings"} onToggleEmail={(enabled) => action("email-settings", () => adminApi.setEmailEnabled(token, enabled))} />}
